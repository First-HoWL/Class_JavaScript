...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    // let login = localStorage.getItem("loginPassword")
    // console.log(login)
    ...
    //     //let passw = new String()
    //     //passw = digestMessage(document.querySelector("input#password").value);
    //     // console.log(passw[["PromiseResult"]])
    //     // alert(passw)
    //     let user = {
    //         login: document.querySelector("input#login").value,
    //         password: document.querySelector("input#password").value //passw
    //     }
    //     if(document.querySelector("input#rememberme").checked == true){
    //         localStorage.setItem("loginPassword", JSON.stringify(user))
    //     }
    //     event.target.submit()
